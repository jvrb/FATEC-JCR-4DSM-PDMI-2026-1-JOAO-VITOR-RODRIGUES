...
export default function Index() {
	...
	function saveInfo() {
		setSaveMsg(`${email} - ${password} - ${confirmPassword} - ${selectedCargo} - ${isEnabled ? "sim" : "não"}`);
	}

	return (
		<View style={styles.container}>
			<View style={styles.main}>
				<Text style={{ color: "#abb251", fontWeight: "bold", textAlign: 'center' }}>CADASTRO</Text>
				...
				<View style={styles.inputWraper}>
					<Text style={{ color: "white" }}>Selecionar usuario</Text>
					<Picker style={styles.picker} selectedValue={selectedCargo} onValueChange={(itemValue, itemIdex) => setSelectedCargo(itemValue)}>
